                    ...
                    <div className="prod_summary_details">
                        {
                            active === 'specs' ? (
                                ...
                                <div className="prod_overview">
                                    <h3>The <span>{title}</span> {info} provides with fabulous Packaging and reviews </h3>
                                    <ul>
                                        <li>Best packaged</li>
                                        <li>High qualitiy Product</li>
                                        <li>No expiery date products</li>
                                    </ul>
                                    <p>Buy the <b>{title} {info}</b> which offers you a best packaging and best quality products with Latest Packaging date.</p>
                                </div>
                            ) : (
